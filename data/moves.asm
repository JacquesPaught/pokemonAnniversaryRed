...
endm
	...
	move POUND,        NO_ADDITIONAL_EFFECT,        40, NORMAL,   100, 40
	...
	move MEGA_PUNCH,   NO_ADDITIONAL_EFFECT,       100, NORMAL,    90, 20
	move PAY_DAY,      PAY_DAY_EFFECT,              50, NORMAL,   100, 20
	move FIRE_PUNCH,   BURN_SIDE_EFFECT1,           80, FIRE,     100, 20
	move ICE_PUNCH,    FREEZE_SIDE_EFFECT,          80, ICE,      100, 20
	move THUNDERPUNCH, PARALYZE_SIDE_EFFECT1,       80, ELECTRIC, 100, 20
	move SCRATCH,      NO_ADDITIONAL_EFFECT,        40, NORMAL,   100, 40
	move VICEGRIP,     NO_ADDITIONAL_EFFECT,        70, NORMAL,   100, 30
	...
	move SLAM,         PARALYZE_SIDE_EFFECT2,       70, NORMAL,   100, 20
	move VINE_WHIP,    NO_ADDITIONAL_EFFECT,        50, GRASS,    100, 25
	move STOMP,        FLINCH_SIDE_EFFECT2,         70, NORMAL,   100, 20
	move DOUBLE_KICK,  ATTACK_TWICE_EFFECT,         40, FIGHTING, 100, 30
	move MEGA_KICK,    NO_ADDITIONAL_EFFECT,       130, FIGHTING,  85,  5
	move JUMP_KICK,    JUMP_KICK_EFFECT,           100, FIGHTING,  95, 15
	move ROLLING_KICK, FLINCH_SIDE_EFFECT2,         80, FIGHTING,  95, 20
	...
	move TACKLE,       NO_ADDITIONAL_EFFECT,        40, NORMAL,   100, 40
	...
	move LOW_KICK,     FLINCH_SIDE_EFFECT2,         70, FIGHTING, 100, 20
	...
	move GROWTH,       SPECIAL_UP2_EFFECT,           0, NORMAL,   100, 20
	...
	move SKY_ATTACK,   CHARGE_EFFECT,              170, FLYING,    90,  5
