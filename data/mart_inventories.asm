...
PewterMartText1:: ; 2449 (0:2449)
	db $FE,8,POKE_BALL,POTION,ANTIDOTE,PARLYZ_HEAL,AWAKENING,BURN_HEAL
	db ESCAPE_ROPE,REPEL,$FF
...
CeladonMart2Text1:: ; 2476 (0:2476)
	db $FE,9,GREAT_BALL,SUPER_POTION,REVIVE,ANTIDOTE,PARLYZ_HEAL
	db AWAKENING,BURN_HEAL,ICE_HEAL,SUPER_REPEL,$FF

; Celadon Dept. Store 2F (2)
CeladonMart2Text2:: ; 2482 (0:2482)
	db $FE,9,TM_01,TM_02,TM_05,TM_07,TM_09,TM_17,TM_32,TM_33,TM_37,$FF
...
CeladonMart5Text3:: ; 2496 (0:2496)
	db $FE,7,X_ATTACK,X_DEFEND,X_SPEED,X_SPECIAL,X_ACCURACY,GUARD_SPEC_
	db DIRE_HIT,$FF
...
SaffronMartText1:: ; 24c3 (0:24c3)
	db $FE,6,GREAT_BALL,HYPER_POTION,REVIVE,FULL_HEAL,ESCAPE_ROPE
	db MAX_REPEL,$FF

; Indigo
IndigoPlateauLobbyText4:: ; 24cc (0:24cc)
	db $FE,7,ULTRA_BALL,GREAT_BALL,FULL_RESTORE,MAX_POTION,REVIVE
	db FULL_HEAL,MAX_REPEL,$FF
	
CeladonMartBasementText1::
	db $FE,7,TM_03,TM_04,TM_06,TM_08,TM_10
	db TM_11,TM_12,$FF

CeladonMartBasementText2::
	db $FE,7,TM_13,TM_14,TM_15,TM_16,TM_18
	db TM_19,TM_20,$FF

CeladonMartBasementText3::
	db $FE,7,TM_21,TM_22,TM_23,TM_24,TM_25
	db TM_26,TM_27,$FF

CeladonMartBasementText4::
	db $FE,7,TM_28,TM_29,TM_30,TM_31,TM_34
	db TM_35,TM_36,$FF

CeladonMartBasementText5::
	db $FE,7,TM_38,TM_39,TM_40,TM_41,TM_42
	db TM_43,TM_44,$FF

CeladonMartBasementText6::
	db $FE,6,TM_45,TM_46,TM_47,TM_48,TM_49
	db TM_50,$FF
